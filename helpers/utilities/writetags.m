...
%                end
    ...
    function eData = writeIndividualTagsAPI(eData, fMap)
        ...
        fclose(fid);
        jsonText = fileread('events.json');
        
        writeeventstsv(eData, 'temp_events.tsv');
        eventsText = fileread('temp_events.tsv');
        ...
        outputReport(response, 'Example 4 assembling HED annotations for events');     
