...
%             tags.prefixQueryTags));
        matchFound = all(ismember(tags.queryTags, tags.allTags) | ...
            cellfun(@(x) any(contains(tags.allTags, x)), ...
            tags.prefixQueryTags));
...
%             length(tags.onsetTag)));
        attributesFound = any(contains(tags.attributePrefix, ...
            tags.allTags) & ...
            ~contains(tags.onsetTag, tags.allTags));
...
%             tags.topLevelTags, length(tags.attributePrefix)));
        matchFound = any(contains(tags.attributePrefix, ...
            tags.topLevelTags));
...
%             length(x))), tags.prefixQueryTags));
        ...
        matchFound = all(ismember(tags.queryTags, tags.groupTags{indx}) ...
            | cellfun(@(x) any(contains(tags.groupTags{indx}, x)), tags.prefixQueryTags));end % partialGroupMatchFound
...
%             length(x))), tags.prefixQueryTags);
        matchIndices = cellfun(@(x) any(contains(tags.topLevelTags, x)), tags.prefixQueryTags);
...
%             p.queryTags, length(p.attributePrefix)));
        containsAllAttributes = all(contains(p.attributePrefix, ...
            p.queryTags));
...
%             tags.queryTags, length(tags.attributePrefix)));
        containsNoAttributes = ~any(contains(tags.attributePrefix, ...
            tags.queryTags));
