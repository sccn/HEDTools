...
% hedStringMatchPositions = findHedStringMatchService(EEG, querystring);
...
% parsedArguments.matchedLatencies = ...
%     parsedArguments.allLatencies(hedStringMatchPositions);
...
%             matchMask = findHedStringMatchService(parsedArguments.EEG, parsedArguments.querystring);
        end       
    end % getMatchMask
